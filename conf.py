...
BLOG_AUTHOR = "Shannon Mason"  # (translatable)
BLOG_TITLE = "Cumulus fractus"  # (translatable)
# This is the main URL for your site. It will be used
# in a prominent link. Don't forget the protocol (http/https)!
SITE_URL = "https://slmason85.github.io/"
# This is the URL where Nikola's output will be deployed.
# If not set, defaults to SITE_URL
# BASE_URL = "https://slmason85.github.io/"
BLOG_EMAIL = "mason.shannon@gmail.com"
BLOG_DESCRIPTION = "Test site for Python, cloud physics, etc."  # (translatable)
